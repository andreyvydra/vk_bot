...
def write_incorrect_msg(user_id):
    vk.method('messages.send', {'user_id': user_id, 'message': 'Несуществующая команда &#10060;\n'
...
def write_info(user_id):
    vk.method('messages.send', {'user_id': user_id, 'message': 'Я бот погоды &#129302; \nПо умолчанию погода будет'
                                                               ' подбираться под '
                                                               'город, который указан у вас в профиле &#127747; \n'
                                                               'Если в профиле город указан не на русском языке, то'
                                                               ' просто нажмите на "выбрать город" и '
                                                               'напишите его на русском языке &#9888; \n'
                                                               'Город всегда можно изменить &#9989;&#9989;&#9989; \nНиже представлен'
                                                               ' список команд,'
                                                               ' которые вы можете вызвать &#128172;\n'
                                                               '&#11015;&#11015;&#11015;&#11015;&#11015;&#11015;&#11015'
                                                               ';&#11015;&#11015;',
                                'random_id': vk_api.utils.get_random_id()})
