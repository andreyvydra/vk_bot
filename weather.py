...
def get_weather(city):
    ...
    ma, mi = b.select('.min')[0].getText().split(), b.select('.min')[1].getText().split()
...
def get_message(city, time=3):
    msg = 'Погода в ' + morph.parse(city)[0].inflect({'loct'}).word.capitalize()
    if 6 >= time >= 0:
        data = get_weather_night(city)
        msg += ' на ночь &#128337;&#127769;&#127747;\n'
        ...
        msg += f'Мин  {symbol}{min(data[0], data[1])}&#176;c &#127777;\n'
        msg += f'Макс  {symbol}{max(data[0], data[1])}&#176;c &#127777;\n'
        ...
        data = get_weather_afternoon(city)
        msg += ' на день &#128337;&#127774;&#127749;\n'
        msg += f'{data[2]} {get_smile(data[2])}\n'
        symbol = '+' if abs(data[0] + data[1]) / 2 == \
                        ((data[0] + data[1]) / 2) else '-'
        ...
        msg += f'Мин  {symbol}{data[1]}&#176;c &#127777;\n'
        msg += f'Макс  {symbol}{data[2]}&#176;c &#127777;\n'
